...
@Tag(name = "로그인 컨트롤러", description = "로그인에 관련 된 API를 다룹니다.")
@RestController
@RequestMapping("/api")
...
"""
    ...
    fun login(
            ...
            @Parameter(description = "로그인 요청 객체") @RequestBody @Valid request: LoginRequest
    ) : ResponseEntity<CommonResponse>{
        return loginService.login(httpSession, request)
    }
