...
class ContentsInfo {
    ...
    @Schema(description = "홈 화면 게시물 정보")
    data class HomeContentsInfo(
            val teamContentsInfos: List<ContentsInfoResponse>? = emptyList(),
            val otherContentsInfos: List<ContentsInfoResponse>? = emptyList()
    )
